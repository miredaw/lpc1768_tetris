...
// Rotation states
#define ROT_0    0  // 0 degrees
#define ROT_90   1  // 90 degrees clockwise
#define ROT_180  2  // 180 degrees
#define ROT_270  3  // 270 degrees clockwise

// Expose tetromino shapes for collision detection
extern const int8_t tetromino_shapes[7][4][4][2];
